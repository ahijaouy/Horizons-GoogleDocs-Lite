...
const styleMap = {
  ...
  BACKGROUND_RED: { backgroundColor: 'rgba(255, 0, 0, 0.6)'},
  BACKGROUND_ORANGE: { backgroundColor: 'rgba(255, 127, 0, 0.6)'},
  BACKGROUND_YELLOW: { backgroundColor: 'rgba(250, 250, 0, 0.8)'},
  BACKGROUND_GREEN: { backgroundColor: 'rgba(0, 180, 0, 0.5)'},
  BACKGROUND_BLUE: { backgroundColor: 'rgba(0, 0, 205, 0.5)'},
  BACKGROUND_INDIGO: { backgroundColor: 'rgba(15, 0, 130, 0.5)'},
  BACKGROUND_VIOLET: { backgroundColor: 'rgba(227, 0, 255, 0.5)'},
};
